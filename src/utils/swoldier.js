...
export const EXERCISES = {
    ...
    tbar_row: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['back'],
        description: 'With the bar between your legs, your legs slightly bent, and with your torso hinged forward at the hips by approximately 45 degrees, row your elbows backwards until the weights touch your chest. Sit back a bit to counter-balance the weight during this exercise.',
        substitutes: ['seated row', 'dumbbell row']
    },
    seated_row: {
        type: 'accessory',
    ...
    barbell_overhead_press: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['shoulders'],
        description: 'Standing with the bar starting at chin height and hands slightly wider than shoulder width, press the bar up and as it moves above head height, press your head forward between your arms.',
        substitutes: ['barbell overhead press', 'arnold press']
    },
    ...
    box_squats: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['quads'],
        description: 'With a barbell on your shoulders, bodyweight, or holding a dumbbell, situate yourself standing infront of, and facing away from, a box or chair or simular elevated surface. Position your feet shoulder width apart, and slow squat down, as if sitting back to sit down on the chair. Only lightly touch the chair, before standing back up.',
        substitutes: ['front squats', 'legpress']
    },
    ...
    hamstring_back_extensions: {
        ...
        description: 'On the back extension machine, lock your feet in place and while lowering your torso down over the front of the machine, resist the motion by trying to curl your heels backwards to you , against the foot stop.',
    ...
    seated_hamstring_curl: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['hamstrings'],
        description: 'With you knees locked into place, try to pull your heels back as far as you can towards you.',
        substitutes: ['dumbbell rdls', 'seated hamstring curl']
    },
    tbar_rdls: {
        type: 'accessory',
    ...
    lying_machine_hamstring_curls: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['hamstrings'],
        description: 'Lying on the machine, curl your heels back, and then slowly release.',
    ...
    lying_dumbbell_hamstring_curls: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['hamstrings'],
        description: 'Lying face down on the ground, hold a dumbbell up in the air between your feet, knees bent. Slowly lower the dumbbell down towards the ground, and after touching the ground, curl the dumbbell back up, heels pulling back towards up and up towards the ceiling.',
        substitutes: ['tbar rdls', 'seated hamstring curl']
    },
    cable_leg_adduction: {
        type: 'accessory',
    ...
    hip_thrusts: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['glutes'],
        description: 'With your back rest on an elevated surface, or on the ground, and your knees bent to appoximately 90 degrees, thrust your hips forward and tuck your chin. Without moving your heels, try to pull them back throughout the motion.',
    ...
    unilateral_hip_thrusts: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['glutes'],
        description: 'With your back rest on an elevated surface, or on the ground, and one knee bent to appoximately 90 degrees (the ohter leg extended), thrust your hips forward and tuck your chin. Without moving your heel, try to pull them back throughout the motion.',
        substitutes: ['cable kickbacks']
    },
    deadlift: {
        type: 'compound',
    ...
    froggy_pumps: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['glutes'],
        description: 'Lying flat on your back, drag your feet back towards your until your knees are bent at a 90 degree angle. With your feet still firm on the ground and touching, drop your knees to either side of your body. Now that you are in position, push down through the outsides of your feet and lower back lift off the ground. Pause while elevated, and then lower back down.',
    ...
    tricep_dip: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['triceps'],
        description: 'Perform with a bench behind you and your legs out in-front of you, your body supported by your hands on the bench. Slowly lower down in-front of the bench, elbows tucked and tracking back behind you, and then press back up.',
        substitutes: ['rope cable pushdown']
    },
    ...
    jack_knives: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['abs'],
        description: 'Sitting on your heiny in a V shape with your knees bent and feet elevated, your hands stabilizing your body either side and slightly behind you, extend your legs our keeping them elevated and lean back slightly. Then bring your knees back in to your chest. Maintain a tucked core throughout this movement.',
    ...
    russian_twists: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['abs'],
        description: 'Sitting  with your legs bent at 90 degrees in front of your and your feet on the ground, lean back about 30 degrees and twist your torso and shoulders, touching the ground on either side with both hands, and then repeat, both hands to the other side.',
    ...
    plank: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['abs'],
        description: 'Be the plank. Make sure your hips are tucked, your core tight, flat as a pancake.',
    ...
    hanging_knee_raises: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['abs'],
        description: 'hang from the bar, raise your knees up, tuck your core, and hopefully you can touch your forehead to your knees. Release slowly down and try to reduce swinging momentum.',
    ...
    mountain_climbers: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['abs'],
        description: 'In a push-up position, bring one knee up to touch one elbow, and then resume push-up position. Repeat on the other side. Avoid letting your lower back sag during the motion.',
