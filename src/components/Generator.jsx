...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id = {'generate'} header ={"generate your workout"} title={['It\'s ', 'Huge', 'o\'clock']}>
            <Header index={'01'} title={'Pick Your Poison'} description={"Select The Workout Split You Wish To Use"}/>
            ...
            <Header index={'02'} title={'Lock on target'} description={"Select The Muscles To Workout."}/>
            ...
            <Header index={'03'} title={'Hit Your Goals'} description={"Select Your ultimate objective"}/>
